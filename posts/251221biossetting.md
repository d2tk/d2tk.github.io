...
처음에 windows 11 설치시에만 강제되는 상황이고 그 이후에는 무엇을 선택해도 정상 부팅 가능합니다

- IOMMU - Disabled 
IOMMU (Input-Output Memory Management Unit)
가상화와 관련되어 있어 메모리상황에 따라 이게 독이 될수도 저는 고민을 하다 사용하지 않는 방향을 선택했습니다
...
- SVM -Disabled
가상화 기능 off (Docker나 VM을 사용하시려면 활성화 하셔야 합니다)
